...
var getShortUrl = function (longUrl, longToShortHash, shortToLongHash) {
    ...
    // also, Postman won't redirect to the page if 'http://' the protocol is missing
...
var convertTo62 = function (num) {
    var result = '';
    do { // avoid num = 0 leading to exit => js thinks num = 0 as 'null'
        result = encode[num % 62] + result;
        num = Math.floor(num / 62); // unlike java, have to calculate int by floor()
    } while (num);
